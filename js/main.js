$(document).ready(function() {
	...
	var slider = $( "<div id='slider-futcoins'></div>" ).insertAfter( select ).slider({
		...
		change: function(event, ui) { 
			...
			else if (sliderValue == '12000') {
				progressBar(60, $('#progressBar'));
			}
			else if (sliderValue == '16000') {
	...
	var sliderCurrentValue = $( "#slider-futcoins" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 4000 );
	});
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() {
					...
					$console_message.text('تحميل ملفات');	
					progressBarConsole(3, $('#progressBarConsole'));			
				}, 0 );
				setTimeout(function() { 
					$console_message.text('جاري تحضير الملفات');	
					progressBarConsole(15, $('#progressBarConsole'));			
				}, 1000 );
				setTimeout(function() { 
					$console_message.text('في طور التحميل');	
					progressBarConsole(18, $('#progressBarConsole'));			
				}, 1800 );
				setTimeout(function() { 
					$console_message.html("جاري البحث عن <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>");	
					progressBarConsole(22, $('#progressBarConsole'));			
				}, 3000 );
				setTimeout(function() { 
					$console_message.html("جاري الاتصال مع <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> على منصة <span class='console-message-connected-item'>" + $console_message_platform_msg + "</span> ");	
				...
				setTimeout(function() { 
					$console_message.html("تم الاتصال بنجاح مع <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>");
				...
				setTimeout(function() { 
					$console_message.html("الاستعداد لتوليد الموارد");	
					progressBarConsole(35, $('#progressBarConsole'));			
				}, 10000 );
				setTimeout(function() { 
					$console_message.html("جاري توليد الشدات المطلوبة");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 11000 );
				setTimeout(function() { 
					$console_message.html("في طور توليد <span class='console-message-connected-item'>" + $console_message_futcoins_msg + "</span> شدة");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_futcoins_msg + "</span> <span class='console-message-success'> تم توليد الشدات بنجاح</span>");
				...
				setTimeout(function() { 
					$console_message.html("جاري الاستعداد لارسال الشدات");	
					progressBarConsole(58, $('#progressBarConsole'));			
				}, 18000 );
				setTimeout(function() { 
					$console_message.html("الاستعداد لارسال الشدات المطلوبة");	
					progressBarConsole(62, $('#progressBarConsole'));			
				}, 19500 );
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>في طور إرسال الشدات المطلوبة</span>");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-success'>تم توليد جميع الموارد بنجاح</span>");	
					progressBarConsole(80, $('#progressBarConsole'));			
				}, 24900 );
				setTimeout(function() { 
					$console_message.html("تحسين الحزم المتولدة");	
					progressBarConsole(84, $('#progressBarConsole'));			
				}, 25900 );
				setTimeout(function() { 
					$console_message.html("تنظيف آثار العملية");	
					progressBarConsole(90, $('#progressBarConsole'));			
				}, 27000 );
				setTimeout(function() { 
					$console_message.html("أداء التحقق البشري التلقائي");	
					progressBarConsole(93, $('#progressBarConsole'));			
				}, 28000 );
				setTimeout(function() { 
					$console_message.html("<span class='console-message-error'>فشل التحقق البشري التلقائي</span>");	
					progressBarConsole(93, $('#progressBarConsole'));			
				}, 30000 );
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>طلب التحقق البشري اليدوي</span>");
					$(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
						$(this).removeClass('pulse animated');
					});
					progressBarConsole(93, $('#progressBarConsole'));			
				...
				setTimeout(function() {
					...
					$console_message.html("في انتظار التحقق البشري");	
					if ($(window).width() < 600) {
	...
	$('#second-step-button').click(function() {
		if ($('#account-username').val() != '') {
			...
			swal("حصل خطأ", "المرجو منك إدخال اسمك في اللعبة", "error");
		}
	});
